...
buffer_t *int_buffer(void);

/**
 * _memcpy - Copies n bytes from memory area src to
 * the buffer conatined in a buffer_t struct.
...
/**
 * int_buffer - Initializes a variable od struct type buffer_t.
 *
 * Return: A pointer to teh initialized buffer_t.
 */
buffer_t *int_buffer(void)
{
	buffer_t *output;
